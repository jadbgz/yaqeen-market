...
export function SellerChrome({ shopName, shopStatus, userName, activeRoute = "overview", children }: {
  ...
  userName: string;
  activeRoute?: "overview" | "products" | "orders";
