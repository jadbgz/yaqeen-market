  ...
  return (
    <SellerChrome shopName={shop.name} shopStatus={shop.status} userName={userName}>
      <div className="seller-content">
        <div className="seller-welcome"><div><p className="seller-kicker">TABLEAU DE BORD RÉEL</p><h1>Construisons votre<br />catalogue<span>.</span></h1></div><span className="seller-next-label">PROCHAINE ÉTAPE · PRODUITS</span></div>
        ...
        <section className="seller-real-empty"><p>PROCHAINE FONCTIONNALITÉ</p><h2>Ajouter le premier produit.</h2><p>Le prochain incrément permettra de créer une fiche, ses variantes, son stock et ses preuves avant de la soumettre à la modération.</p><span>Commandes et chiffre d’affaires resteront absents jusqu’à l’existence d’un vrai flux de commande.</span></section>
      </div>
    </SellerChrome>
  );
}
