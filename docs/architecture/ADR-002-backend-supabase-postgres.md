...
- 51 assertions pgTAP et lint PostgreSQL ajoutés à la CI, incluant l'onboarding vendeur, la création atomique d'un brouillon produit et trois scénarios d'attaque directe du catalogue.
