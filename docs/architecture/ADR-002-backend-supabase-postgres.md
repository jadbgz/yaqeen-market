...
- 77 assertions pgTAP et lint PostgreSQL ajoutés à la CI, incluant l'onboarding vendeur, la création atomique, les attaques directes et le workflow complet de modération.
